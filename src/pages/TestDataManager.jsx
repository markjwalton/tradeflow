        ...
        <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
          ...
          {validationResults && (
            <div className="flex-1 overflow-auto space-y-4">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <Card className="bg-red-50 border-red-200">
                  <CardContent className="pt-4">
                    ...
                    <div className="text-sm text-red-600">Missing/Empty Schemas</div>
                  </CardContent>
                </Card>
              ...
              {/* Alert for issues */}
              {validationResults.invalidEntities > 0 && (
                <Alert variant="destructive">
                  <AlertTriangle className="h-4 w-4" />
                  <AlertTitle>Schema Issues Found</AlertTitle>
                  <AlertDescription>
                    {validationResults.missingSchemas} entities have missing or empty schemas. 
                    Test data generation will use generic fields for these entities.
                  </AlertDescription>
                </Alert>
              )}
