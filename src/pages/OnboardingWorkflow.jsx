...
export default function OnboardingWorkflow() {
  ...
  const createTestDataMutation = useMutation({
    mutationFn: async () => {
      try {
        console.log('Starting test data creation...', { sessionId, tenantId: session.tenant_id });
        ...
        console.log('Tenant profile created:', profile.id);
        ...
        console.log('Requirements created:', requirements.length);
