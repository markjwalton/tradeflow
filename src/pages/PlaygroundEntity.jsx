          ...
          <CardContent>
            {template ? (
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-medium text-muted-foreground mb-2">Fields ({Object.keys(template.schema?.properties || {}).length})</h4>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {template.schema.required.map(f => (
                        <Badge key={f} className="bg-destructive-50 text-destructive-700">{f}</Badge>
                      ))}
                    </div>
                  </div>
                )}
