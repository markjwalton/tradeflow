...
export function BasicCard({ 
  ...
  return (
    <div className={cn(cardBase, "p-6", className)} {...props}>
      {title && (
        <h3 className="text-lg font-light text-midnight-900 font-display mb-1">
          {title}
        </h3>
      )}
      {description && (
    ...
    >
      {icon && (
        <div className={cn(
          ...
          highlight ? "bg-primary-500 text-white" : "bg-secondary-100 text-secondary-500"
        )}>
          {icon}
        </div>
      )}
      <h3 className="text-xl font-light text-midnight-900 font-display mb-2">
        {title}
      </h3>
      {description && (
        <p className="text-charcoal-500 font-body">{description}</p>
      )}
    </div>
  );
}
    ...
    <div className={cn(cardBase, "p-6", className)} {...props}>
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-3xl font-light text-midnight-900 font-display">
            {value}
          </p>
          {change !== undefined && (
            <div className={cn(
...
export function ProductCard({ 
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <h3 className="text-base font-medium text-midnight-900 font-display mb-2 line-clamp-2">
          {title}
        </h3>
...
export function ProfileCard({ 
  ...
  return (
    <div className={cn(cardBase, "p-6 text-center", className)} {...props}>
      ...
      <h3 className="text-xl font-light text-midnight-900 font-display mb-1">
        {name}
      </h3>
      {role && (
      ...
      {bio && (
        <p className="text-sm text-charcoal-500 font-body mb-4">{bio}</p>
      )}
      {actions && (
...
export function TestimonialCard({ 
  ...
  return (
    <div className={cn(cardBase, "p-6", className)} {...props}>
      ...
      <blockquote className="text-charcoal-800 font-body mb-4 italic">
        "{quote}"
      </blockquote>
