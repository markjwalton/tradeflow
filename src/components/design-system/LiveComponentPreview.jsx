...
const bgColors = [
  ...
  { label: 'Primary 200', value: 'var(--primary-200)' },
  { label: 'Primary 300', value: 'var(--primary-300)' },
  { label: 'Primary 400', value: 'var(--primary-400)' },
  { label: 'Primary 500', value: 'var(--primary-500)' },
  { label: 'Primary 600', value: 'var(--primary-600)' },
  { label: 'Primary 700', value: 'var(--primary-700)' },
  { label: 'Primary 800', value: 'var(--primary-800)' },
  { label: 'Primary 900', value: 'var(--primary-900)' },
  { label: 'Secondary 50', value: 'var(--secondary-50)' },
  { label: 'Secondary 100', value: 'var(--secondary-100)' },
  { label: 'Secondary 200', value: 'var(--secondary-200)' },
  { label: 'Secondary 300', value: 'var(--secondary-300)' },
  { label: 'Secondary 400', value: 'var(--secondary-400)' },
  { label: 'Secondary 500', value: 'var(--secondary-500)' },
  { label: 'Secondary 600', value: 'var(--secondary-600)' },
  { label: 'Secondary 700', value: 'var(--secondary-700)' },
  { label: 'Secondary 800', value: 'var(--secondary-800)' },
  { label: 'Secondary 900', value: 'var(--secondary-900)' },
  { label: 'Accent 50', value: 'var(--accent-50)' },
  { label: 'Accent 100', value: 'var(--accent-100)' },
  { label: 'Accent 200', value: 'var(--accent-200)' },
  { label: 'Accent 300', value: 'var(--accent-300)' },
  { label: 'Accent 400', value: 'var(--accent-400)' },
  { label: 'Accent 500', value: 'var(--accent-500)' },
  { label: 'Accent 600', value: 'var(--accent-600)' },
  { label: 'Accent 700', value: 'var(--accent-700)' },
  { label: 'Accent 800', value: 'var(--accent-800)' },
  { label: 'Accent 900', value: 'var(--accent-900)' },
  { label: 'Midnight 50', value: 'var(--midnight-50)' },
  { label: 'Midnight 100', value: 'var(--midnight-100)' },
  { label: 'Midnight 200', value: 'var(--midnight-200)' },
  { label: 'Midnight 300', value: 'var(--midnight-300)' },
  { label: 'Midnight 400', value: 'var(--midnight-400)' },
  { label: 'Midnight 500', value: 'var(--midnight-500)' },
  { label: 'Midnight 600', value: 'var(--midnight-600)' },
  { label: 'Midnight 700', value: 'var(--midnight-700)' },
  { label: 'Midnight 800', value: 'var(--midnight-800)' },
  { label: 'Midnight 900', value: 'var(--midnight-900)' },
  { label: 'Charcoal 50', value: 'var(--charcoal-50)' },
  { label: 'Charcoal 100', value: 'var(--charcoal-100)' },
  { label: 'Charcoal 200', value: 'var(--charcoal-200)' },
  { label: 'Charcoal 300', value: 'var(--charcoal-300)' },
  { label: 'Charcoal 400', value: 'var(--charcoal-400)' },
  { label: 'Charcoal 500', value: 'var(--charcoal-500)' },
  { label: 'Charcoal 600', value: 'var(--charcoal-600)' },
  { label: 'Charcoal 700', value: 'var(--charcoal-700)' },
  { label: 'Charcoal 800', value: 'var(--charcoal-800)' },
  { label: 'Charcoal 900', value: 'var(--charcoal-900)' },
  { label: 'Destructive 50', value: 'var(--destructive-50)' },
  { label: 'Destructive 100', value: 'var(--destructive-100)' },
  { label: 'Destructive 200', value: 'var(--destructive-200)' },
  { label: 'Destructive 300', value: 'var(--destructive-300)' },
  { label: 'Destructive 400', value: 'var(--destructive-400)' },
  { label: 'Destructive 500', value: 'var(--destructive-500)' },
  { label: 'Destructive 600', value: 'var(--destructive-600)' },
  { label: 'Destructive 700', value: 'var(--destructive-700)' },
  { label: 'Destructive 800', value: 'var(--destructive-800)' },
...
export function LiveComponentPreview({ jsxCode, componentName, componentState = 'default', shadowEffect = 'none', animation = 'none', buttonVariant = 'default', buttonSize = 'default', editMode = 'global', hasEdits = false, onEditModeChange }) {
  ...
  useEffect(() => {
    ...
    const handleApplyStyle = (event) => {
      setAppliedStyles(prev => [...prev, event.detail]);
    };
    window.addEventListener('save-style-configuration', handleSaveStyle);
    window.addEventListener('apply-style-configuration', handleApplyStyle);
    return () => {
      window.removeEventListener('save-style-configuration', handleSaveStyle);
      window.removeEventListener('apply-style-configuration', handleApplyStyle);
    };
  }, []);
    ...
    const renderStaticPreview = () => {
      ...
      if (jsxCode.includes('<Button')) {
        ...
        const handleLoadStyle = (style) => {
          ...
          window.dispatchEvent(new CustomEvent('load-style-for-editing', { detail: style }));
          toast.info(`Loaded: ${style.name}`);
        };

        const handleDeleteStyle = (index) => {
          const style = appliedStyles[index];
          setAppliedStyles(prev => prev.filter((_, i) => i !== index));
