// Violation Report tab - extracted from ViolationReport.js
    ...
    <div className="grid grid-cols-[1fr_300px] gap-6">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold">Interactive Violation Report</h2>
            <p className="text-sm text-muted-foreground">AI extracts patterns, you confirm or refine them for learning</p>
          </div>
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2 ml-4">
                      <Button size="sm" variant="ghost" onClick={() => handleAskAI(pattern)}>
                      ...
                      <Button size="sm" variant="default" onClick={() => handleConfirmPattern(pattern)}>
                        <Check className="h-4 w-4" />
                      </Button>
                      <Button size="sm" variant="destructive" onClick={() => handleRejectPattern(pattern)}>
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                  </div>
