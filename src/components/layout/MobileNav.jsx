...
import { X, ChevronDown, ChevronRight, Folder, FolderOpen, Home, LogOut, Settings } from "lucide-react";
        ...
        {user && (
          <div className="p-4 shrink-0">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-muted hover:bg-muted/80 rounded-lg transition-colors min-h-[44px]"
            >
