...
```jsx
// Using PropTypes (runtime)
import PropTypes from 'prop-types';

function UserCard({ user, size, onEdit }) {
...
// Using TypeScript (compile-time - preferred)
interface User {
  id: string;
  name: string;
  email?: string;
...
<Box as={Link} to="/home">Rendered as Link</Box>
```

### Slot Pattern

```jsx
function Modal({ trigger, header, content, footer }) {
...
- [ ] Can it be composed from smaller pieces?
