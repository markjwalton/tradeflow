...
export default function CarouselLoop({
  ...
  const defaultItems = [
    { title: 'Welcome to TradeFlow', description: 'Manage your projects with ease and efficiency' },
    { title: 'Powerful Features', description: 'Everything you need to streamline your workflow' },
    { title: 'Beautiful Design', description: 'Built with your design system in mind' },
    { title: 'Infinite Scrolling', description: 'Smooth carousel with infinite loop capability' },
  ];
